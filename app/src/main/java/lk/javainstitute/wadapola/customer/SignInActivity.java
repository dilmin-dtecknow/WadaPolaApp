...
import lk.javainstitute.wadapola.worker.WorkerSignInActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (customer != null){
            if (type.equals("worker")){
                Intent intent = new Intent(SignInActivity.this, WorkerHomeActivity.class);
        ...
        EditText editText1 = findViewById(R.id.editTextSigninEmail1);
        EditText editText2 = findViewById(R.id.signInPassword1);

        Button buttonLogin = findViewById(R.id.buttonLogin1);
...
//
                if (emailSign.isBlank()){
                    cusErrorToast("please enter email",false);
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    if (result.size() == 1){
                                        ...
                                        if (verify_status.equals("Verified")){
                                            ...
                                            Intent intent = new Intent(SignInActivity.this, SensorVerificationActivity.class);
...
//                                            not verified
                                            Toast.makeText(SignInActivity.this, verify_status, Toast.LENGTH_SHORT).show();
                                            ...
                                            new Thread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    Request request = new Request.Builder()
                                                            .url("https://c862-2402-4000-1200-f846-1802-c626-7ea2-202e.ngrok-free.app/WadaPolaServer/MailVerification?email="+emailSign)
                                                            .build();
...
//                                                                Toast.makeText(SignInActivity.this, "Verification Code: " + verificationCode, Toast.LENGTH_LONG).show();
                                                                ...
                                                                firestore.collection("customer").document(logUserId).update(document)
...
//                                    CustomToast.cusErrorToast(SignInActivity.this,"Some thing went wrong",false);
                                    Toast.makeText(SignInActivity.this, "some thing went wrong", Toast.LENGTH_SHORT).show();
        ...
        Button buttonWorkerSignIn = findViewById(R.id.buttonWorkerSignIn);
        buttonWorkerSignIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SignInActivity.this, WorkerSignInActivity.class);
                startActivity(intent);
            }
        });
    }
